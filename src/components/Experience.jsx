  ...
  const experiences = [
    {
      ...
      period: "2023 - 2024",
      description:
        "Worked on Practical Ecommerce Company & Relate Online Platform.",
    },
    {
      icon: Layers,
        ...
        <div className="relative container mx-auto px-4 py-24">
          ...
          <div className="flex flex-col items-center space-y-6 mb-16">
            <div className="relative">
              <h2 className="text-4xl md:text-6xl font-extrabold text-transparent bg-gradient-to-br from-green-400 via-sky-400 to-green-500 bg-clip-text">
