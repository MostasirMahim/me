...
const ProjectShowcase = () => {
  const projects = [
    ...
    {
      title: "MahimAI - PDF Analyzer",
      description:
        "MahimAI is an AI chatbot that is powered by Gemini, a powerful AI engine that can understand and respond to user queries with uploaded PDF files. MahimAI can provide information, answer questions, and even save chats on browser local storage.",
      tags: [
        "Vite",
        "Tailwind",
        "Gemini",
      ...
      links: {
        github: "https://github.com/MostasirMahim",
        demo: "https://mahimai.onrender.com",
      },
      image: mahimai,
      featured: false,
    },
